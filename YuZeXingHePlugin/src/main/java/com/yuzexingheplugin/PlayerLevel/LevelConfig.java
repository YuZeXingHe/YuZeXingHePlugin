        ...
        if (sender instanceof Player) {
            ...
            if (player.isOp()) {
                if (args.length > 0) {
                    ...
                    // 修改配置文件相关内容
                    if (args.length > 1 && Command1.equals("blockbreak") || Command1.equals("killedCreatures") || Command1.equals("LevelUp") || Command1.equals("MaxLevel") || Command1.equals("blockbreakExperience") || Command1.equals("killedCreaturesExperience")) {
